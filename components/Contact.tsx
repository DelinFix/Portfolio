...
//TODO добавить фото, написать о себе, доделать форму
        ...
        <div className="w-full lg:h-screen" id="contact">
            <div className="max-w-[1240px] m-auto px-2 py-16 w-full">
                ...
                <div className="flex justify-center py-12">
                    <Link href="/">
                        <div className="rounded-full shadow-lg shadow-gray-400 p-4 cursor-pointer ease-in duration-300 hover:scale-105">
